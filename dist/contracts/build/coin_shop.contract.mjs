...
export function _getViews(s, viewlib) {
    ...
    const _coin_prices = async (i, svs, args) => {
        ...
        if (stdlib.eq(i, stdlib.checkedBigNumberify("<builtin>", stdlib.UInt_max, "3"))) {
            const [v6629, v6630, v6631, v6632, v6654, v6695, v6696, v6704, v6705, v12146, v12147, v12149, v12151, v12152,] = svs;
            return await (async () => {
                return v6695;
            })(...args);
        }
        if (stdlib.eq(i, stdlib.checkedBigNumberify("<builtin>", stdlib.UInt_max, "5"))) {
            const [v6629, v6630, v6631, v6632, v6654, v6695, v6696, v6697, v6704, v6705, v6735, v6737, v6738, v6739, v6740, v6741, v6742, v6743, v6744, v6746, v6747, v6748,] = svs;
            return await (async () => {
                return v6695;
            })(...args);
        }
...
export async function Admin(ctcTop, interact) {
    ...
    const { data: [v6630, v6631, v6632], secs: v6634, time: v6633, didSend: v439, from: v6629, } = txn1;
    ...
    const { data: [], secs: v6692, time: v6691, didSend: v845, from: v6690, } = txn2;
    ...
    while (await (async () => {
        ...
        const { data: [v7228], secs: v7230, time: v7229, didSend: v5406, from: v7227, } = txn4;
        switch (v7228[0]) {
    ...
    const txn4 = await ctc.sendrecv({
        ...
        sim_p: async (txn4) => {
            ...
            const { data: [], secs: v12165, time: v12164, didSend: v6024, from: v12163, } = txn4;
            sim_r.txns.push({
                kind: "from",
                to: v6654,
                tok: undefined,
...
export async function Deployer(ctcTop, interact) {
    ...
    const txn2 = await ctc.sendrecv({
        ...
        sim_p: async (txn2) => {
            ...
            const v6698 = v6691;
            const v6704 = v6647;
            const v6705 = stdlib.checkedBigNumberify("./src/contracts/coin_shop.rsh:95:15:after expr stmt semicolon", stdlib.UInt_max, "0");
            if (await (async () => {
                const v6722 = v6697 ? false : true;
                return v6722;
            })()) {
...
export async function _buyer_api_bronze5(ctcTop, interact) {
    ...
    const [v6629, v6630, v6631, v6632, v6654, v6695, v6696, v6697, v6704, v6705, v6735, v6737, v6738, v6739, v6740, v6741, v6742, v6743, v6744, v6746, v6747, v6748,] = await ctc.getState(stdlib.checkedBigNumberify("<builtin>", stdlib.UInt_max, "5"), [
        ctc0,
        ctc1,
        ctc1,
        ctc1,
    ...
    const txn1 = await ctc.sendrecv({
        ...
        sim_p: async (txn1) => {
            ...
            const { data: [v7228], secs: v7230, time: v7229, didSend: v5406, from: v7227, } = txn1;
            switch (v7228[0]) {
                case "buyer_api_bronze0_907": {
                    const v7231 = v7228[1];
                    sim_r.txns.push({
